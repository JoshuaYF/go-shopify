...
type Order struct {
	...
	SubtotalPrice            *decimal.Decimal       `json:"subtotal_price,omitempty"`              // no use
	...
	Token                    string                 `json:"token,omitempty"`                       // deprecated
	...
	CheckoutToken string `json:"checkout_token,omitempty"` // deprecated
